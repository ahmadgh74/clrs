...
from src.find_max_subarray import find_max_subarray_bf


class TestFindMaxSubarrayBF(unittest.TestCase):

    def test_find_max_1(self):
        data = [3, 4, -2, 3, -10, 32, 4, -11, 7, -3, 2]
        expected = (5, 6, 36)

        self.assertEqual(find_max_subarray_bf(data), expected)
